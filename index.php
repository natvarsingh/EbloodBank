...
<?php include('includes/slider.php');?>
    ...
    <div class="container">
        ...
        <h1 class="my-4">Welcome to E-Blood of Rajasthan</h1>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">The need for blood</h4>
                        ...
                        <p class="card-text" style="padding-left:2%"> When is blood needed? Blood is needed at regular intervals and at all times as it has only a finite time to store. Red blood cells can be stored for about 42 days, Fresh Frozen Plasma and Cryoprecipitate for a year and platelets for 5 days.</p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Who can donate blood</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Anyone above 18 years weighing more than 50kgs (110 lbs) can donate blood. At the time of donation, you should not be suffering from fever or had consumed alcohol 48 hours before or smoked during that day.</p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Eligibility to donate</h4>
                   
                        <p class="card-text" style="padding-left:2%">You should not be suffering from any of the following diseases or taking medicines for them</p>
						<ul>
<li>Hepatitis B, C</li>
<li>AIDS</li>
